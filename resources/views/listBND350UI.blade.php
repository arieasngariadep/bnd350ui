            ...
            <div class="card-body scrollme">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 text-left">
                        <?php if($txn_date != NULL || $proc_date != NULL || $mid != NULL || $cardnum != NULL || $auth != NULL || $amount != NULL) : ?>
                        <div class="col-md-5 text-left">
                            <form class="form-inline" action="<?= route('prosesReportSearchExport') ?>" method="POST">
                                @csrf
                                <input type="text" class="form-controle" name="txn_date" value="<?= $txn_date ?>" hidden />
                                <input type="text" class="form-controle" name="proc_date" value="<?= $proc_date ?>" hidden />
